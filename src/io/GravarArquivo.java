...
//Esta classe cria um objeto que e um arquivo para gravacao
public class GravarArquivo {
     ...
     * @throws IOException => Excecao se houver algum problema se o arquivo nao
     * puder ser aberto para gravacao
     */
    public GravarArquivo(String nome) throws IOException {
        try {
            // false significa que se o arquivo ja existir, ele sera sobrescrito
            // caso queira apenas acrescentar dados ao final do arquivo, 
            // deve usar true. Se o arquivo nao existir, cria um.
            writer = new FileWriter(new File(nome), false);
            // esse objeto significa que significando que 0 arquivo poderá sofrer 
            // inclusão de dados. O segundo argumento (opcional) indica (true) 
            // que os dados serão enviados para o arquivo a toda chamada do método 
            // println(), caso contrário, os dados só são enviados quando voce enviar 
            // uma quebra de linha, fechar o arquivo ou mandar ele atualizar as 
